...
function Cuisine() {
    ...
    const getCuisine = async (name) =>{
        const data = await fetch(`https://api.edamam.com/api/recipes/v2?type=public&q=${name}&app_id=${process.env.REACT_APP_APP_ID}&app_key=${process.env.REACT_APP_APP_KEY}`);
